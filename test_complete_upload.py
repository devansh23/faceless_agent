#!/usr/bin/env python3
"""
Complete test: Upload image, audio, and press upload button
"""
...
def test_complete_upload():
    """Test complete upload process: image + audio + upload button"""
    ...
    try:
        with sync_playwright() as p:
            ...
            if not upload_button:
                ...
                print("🔍 Let's look for all buttons on the page...")
                ...
                for i, button in enumerate(all_buttons):
                    try:
                        ...
                        print(f"   Button {i+1}: text='{text_content}', aria-label='{aria_label}', class='{class_name}'")
                    except:
